...
public class GatheringController {
	...
	public Result findAll(){
		return new Result(StatusCode.OK,"查询成功",gatheringService.findAll(),true);
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(StatusCode.OK,"查询成功",gatheringService.findById(id),true);
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new Result(StatusCode.OK,"查询成功",  new PageResult<Gathering>(pageList.getTotalElements(), pageList.getContent()),true );
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return new Result(StatusCode.OK,"查询成功",gatheringService.findSearch(searchMap),true);
    }
