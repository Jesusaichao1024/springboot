...
public class ReplyController {
	...
	public Result findAll(){
		return new Result(StatusCode.OK,"查询成功",replyService.findAll(),true);
	}
	...
	public Result findById(@PathVariable String id){
		return new Result(StatusCode.OK,"查询成功",replyService.findById(id),true);
	}
	...
	public Result findSearch(@RequestBody Map searchMap , @PathVariable int page, @PathVariable int size){
		...
		return  new Result(StatusCode.OK,"查询成功",  new PageResult<Reply>(pageList.getTotalElements(), pageList.getContent()) ,true);
	}
    ...
    public Result findSearch( @RequestBody Map searchMap){
        return new Result(StatusCode.OK,"查询成功",replyService.findSearch(searchMap),true);
    }
