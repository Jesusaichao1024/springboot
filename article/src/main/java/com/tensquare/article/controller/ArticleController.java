...
public class ArticleController {
    ...
    public Result findAll() {
        return new Result(StatusCode.OK, "查询成功", articleService.findAll(), true);
    }
    ...
    public Result findById(@PathVariable String id) {
        return new Result(StatusCode.OK, "查询成功", articleService.findById(id), true);
    }
    ...
    public Result findSearch(@RequestBody Map searchMap, @PathVariable int page, @PathVariable int size) {
        ...
        return new Result(StatusCode.OK, "查询成功", new PageResult<Article>(pageList.getTotalElements(), pageList.getContent()), true);
    }
    ...
    public Result findSearch(@RequestBody Map searchMap) {
        return new Result(StatusCode.OK, "查询成功", articleService.findSearch(searchMap), true);
    }
    ...
    public Result examine(@PathVariable("id") String id) {
        ...
        return new Result(StatusCode.OK, "审核成功", true);
    }
